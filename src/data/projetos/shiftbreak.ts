...
export const shiftbreak: Projeto = {
  ...
  descricaoCompleta: [
    'SHIFTBREAK é um jogo de ação frenético sobre dominar o mesmo local de trabalho de maneiras diferentes.',
    'Você está preso em um escritório hostil repleto de inimigos sombrios, e avançar em cada nível significa aproveitar ao máximo suas habilidades. Mova-se rapidamente, experimente abordagens diferentes e descubra como cada habilidade pode mudar a forma como você lida com os mesmos espaços familiares.',
    'O ambiente pode continuar o mesmo, mas o desafio não. Conforme você avança, as situações mudam e forçam você a encarar salas, inimigos e rotas de uma perspectiva diferente. Um caminho que funcionou antes pode não ser a melhor opção na próxima tentativa.',
    'Aprenda o layout, adapte sua estratégia e sobreviva a mais um turno perigoso.',
    'Mesmo escritório. Soluções diferentes. Mais um turno.',
  ],
